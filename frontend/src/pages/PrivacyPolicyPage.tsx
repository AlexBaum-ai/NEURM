/**
 * Privacy Policy Page
 * Displays the platform's privacy policy with dynamic content from backend
 */
...
const PrivacyPolicyPage: React.FC = () => {
  const { data: document, isLoading, error } = useLegalDocument('privacy');
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg p-6">
            ...
            <p className="text-red-700 dark:text-red-300">
              We're sorry, but we couldn't load the privacy policy at this time. Please try again
              later.
            </p>
          </div>
        </div>
  ...
  return (
    <>
      <Helmet>
        <title>Privacy Policy - Neurmatic</title>
        <meta
          name="description"
          content="Neurmatic's privacy policy explains how we collect, use, and protect your personal information."
        />
      </Helmet>
