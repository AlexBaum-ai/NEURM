      ...
      <div className="relative px-4 md:px-6 pb-6">
        ...
        <div className="mb-4">
          <div className="flex items-center gap-3 mb-1">
            ...
            {/* Availability Badge */}
            {profile.jobPreferences?.isLookingForWork && (
        ...
        {socialLinks && Object.values(socialLinks).some(link => link) && (
          <div className="flex gap-3 mb-6">
            ...
            {socialLinks.huggingface && (
              ...
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm0 2.4c5.302 0 9.6 4.298 9.6 9.6 0 5.302-4.298 9.6-9.6 9.6-5.302 0-9.6-4.298-9.6-9.6 0-5.302 4.298-9.6 9.6-9.6zM9.6 7.2c-.662 0-1.2.538-1.2 1.2v1.2c0 .662.538 1.2 1.2 1.2s1.2-.538 1.2-1.2V8.4c0-.662-.538-1.2-1.2-1.2zm4.8 0c-.662 0-1.2.538-1.2 1.2v1.2c0 .662.538 1.2 1.2 1.2s1.2-.538 1.2-1.2V8.4c0-.662-.538-1.2-1.2-1.2zM12 13.2c-2.21 0-4 1.79-4 4h8c0-2.21-1.79-4-4-4z" />
                </svg>
              </a>
            )}
          </div>
